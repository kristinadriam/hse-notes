...
$A \sqcup B := A \cup B$ и $A \cap B = \varnothing$ – дизъюнктные множества.

$\bigsqcup\limits_{k=1}^n A_k := \bigcup\limits_{k=1}^n A_k$ и $A_i \cap A_j = \varnothing$

\begin{definition}
    $\{E_\alpha\}_{\alpha\in I}$ – разбиение множества $E$, если $E = \bigsqcup\limits_{\alpha\in I} E$
\end{definition}
...
\begin{definition}
    $\mathcal{A}$ – система подножеств X:
    \begin{enumerate}
...
\begin{definition}
    Система множества $\mathcal{A}$ – \textit{алгебра}, если она симметрична, $\varnothing \not\in \mathcal{A}$, есть свойства $\delta_0$ и $\sigma_0$.
\end{definition}
...
\begin{remark}
    Если $\mathcal{R}$ – кольца и $X\in \mathcal{R}$, то $\mathcal{R}$ – алгебра.
\end{remark}

\begin{definition}
    $\mathcal{P}$ – \textit{получкольцо подмножеств $X$}, если:
    \begin{enumerate}
...
\begin{proof}
    1) $\mathcal{P}^m\supset \mathcal{P}^m_\Q\Rightarrow \mathcal{B}(\mathcal{P}^m)\supset \mathcal{P}^m_\Q\Rightarrow \mathcal{B}(\mathcal{P}^m)\supset \mathcal{B}(\mathcal{P}^m_\Q)$

    2) $\mathcal{P}^m \subset \mathcal{B}^m$
    ...
    3) $G$ – открытое множество $\Rightarrow G\in \mathcal{B}(\mathcal{P}^m_\Q)$ т.к. по теореме
