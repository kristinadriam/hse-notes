...
Внутри Foo надо сказать, какой конкретный Bar является ему другом. А внутри Bar еадо понять, есть ли какой-то Foo,
которому мы является другом.
...
случае вне класса нельзя, только какие-то конкретный случаи.
